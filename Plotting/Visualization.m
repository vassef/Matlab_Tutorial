%% Visualization; figures, axes, subplots
...
% If you have a function, say f(vec1,vec2,...),
% which relys on element-wise vectors's operations,
% you must consider using '.' operator.
t^2 
t.^2 % f(t,t) = t.^2
% Also for division
t./(t+2)
t/(t+2) % ? What happend(Search Array vs. Matrix Operations)
% Matrix multiplication
t * t'        % Inner product
t * [t' 2*t'] % Multiplying two matrix with different shapes.
%% figures
...
% Matlab also allows you to plot data in three dimensions.
% This becomes particularly handy for complex functions 
